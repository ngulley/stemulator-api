# stemulator-api
STEM education API for running interactive and AI guided simulations of science labs that are in alignment with Next Generation Science Standards (NGSS).
